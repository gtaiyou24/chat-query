...
from modules.common.domain.model import DomainEventSubscriber, DomainEvent, DomainEventPublisher
...
class ApplicationServiceLifeCycle:
    ...
    def listen(self):
        ...
        DomainEventPublisher.instance().subscribe(DomainEventSubscriberImpl())
